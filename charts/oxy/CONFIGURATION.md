...
| otelCollector.clickhouse.database | string | `"otel"` |  |
...
| otelCollector.clickhouse.passwordExistingSecret | string | `""` |  |
| otelCollector.clickhouse.passwordSecretKey | string | `"password"` |  |
...
| otelCollector.clickhouse.tcpEndpoint | string | `""` |  |
...
| otelCollector.clickhouse.username | string | `"default"` |  |
